...
$(document).on("click", '#nextPage', (e) => {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/KhachHang/change-page",
...
$('#formTimKiem').on('submit', function (e) {
    ...
    if (key !== "") {
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/KhachHang/searchTableKH",
...
function showModalEdit(id) {
    ...
    $.ajax({
        type: "get",
        url: "/DanhMuc/KhachHang/show-modal/" + id,
        success: function (result) {
            $('#contentModal').empty();
...
$('#btnModal').on('click', (e) => {
    fetch("/DanhMuc/KhachHang/update-kh", {
        method: 'POST',
        headers: {
