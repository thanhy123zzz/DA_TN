...
$(document).on("click", '#nextPage', (e) => {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/NhomHH/change-page",
...
$('#formTimKiem').on('submit', function (e) {
    ...
    if (key !== "") {
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/NhomHH/searchTableNhomHH",
...
function showModalEdit(id) {
    ...
    $.ajax({
        type: "get",
        url: "/DanhMuc/NhomHH/show-modal/" + id,
        success: function (result) {
            $('#contentModal').empty();
...
$('#btnModal').on('click', function (e){
    ...
    if (!form.checkValidity()) {
        ...
        fetch("/DanhMuc/NhomHH/update-nhomhh", {
            method: 'POST',
            headers: {
...
function deleteNhomHH(id) {
    if (confirm("Bạn có muốn thực hiện thao tác này?")) {
        $("#loader").show();
        $('#tBody').empty();
        $.ajax({
            type: "post",
            url: "/DanhMuc/NhomHH/remove",
