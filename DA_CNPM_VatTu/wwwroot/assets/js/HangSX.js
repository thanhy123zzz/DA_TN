...
$(document).on("click", '#nextPage', (e) => {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/HangSX/change-page",
...
$('#formTimKiem').on('submit', function (e) {
    ...
    if (key !== "") {
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/HangSX/searchTableHangSX",
...
function showModalEdit(id) {
    ...
    $.ajax({
        type: "get",
        url: "/DanhMuc/HangSX/show-modal/" + id,
        success: function (result) {
            $('#contentModal').empty();
...
$('#btnModal').on('click', (e) => {
    fetch("/DanhMuc/HangSX/update-hangsx", {
        method: 'POST',
        headers: {
