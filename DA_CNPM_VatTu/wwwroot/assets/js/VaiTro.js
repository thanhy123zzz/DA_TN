...
$(document).on("click", '#nextPage', (e) => {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/VaiTro/change-page",
...
$('#formTimKiem').on('submit', function (e) {
    ...
    if (key !== "") {
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/VaiTro/searchTableVaiTro",
...
function showModalEdit(id) {
    ...
    $.ajax({
        type: "get",
        url: "/DanhMuc/VaiTro/show-modal/" + id,
        success: function (result) {
            $('#contentModal').empty();
...
$('#btnModal').on('click', (e) => {
    fetch("/DanhMuc/VaiTro/update-vt", {
        method: 'POST',
        headers: {
