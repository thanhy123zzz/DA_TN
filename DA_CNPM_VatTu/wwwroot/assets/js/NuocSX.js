...
$(document).on("click", '#nextPage', (e) => {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/NuocSX/change-page",
...
$('#formTimKiem').on('submit', function (e) {
    ...
    if (key !== "") {
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/NuocSX/searchTableNuocSX",
...
function showModalEdit(id) {
    ...
    $.ajax({
        type: "get",
        url: "/DanhMuc/NuocSX/show-modal/" + id,
        success: function (result) {
            $('#contentModal').empty();
...
$('#btnModal').on('click', (e) => {
    fetch("/DanhMuc/NuocSX/update-nuocsx", {
        method: 'POST',
        headers: {
